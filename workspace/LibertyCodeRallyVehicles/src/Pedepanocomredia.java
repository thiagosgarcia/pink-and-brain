...
public class Pedepanocomredia extends DefaultCarAIAgent {
	...
	public void onObstacleInProximity(Obstacle obstacle) {
		// Provide custom logic or remove method for default implementation.
		System.out.println("======= INICIO Obstaculo Info INICIO =========");
		System.out.println("Scale: "+obstacle.getScale());
		System.out.println("Size: "+obstacle.getSize());
		System.out.println("======= FIM Obstaculo Info FIM=========");;
